...
Usage:
    python read_tpr_bonds.py /path/to/directory [options]
...
def main():
    ...
    parser.add_argument(
        "md_dir", help="Path to directory containing MD files (GRO, XTC, TOP)"
    )
    parser.add_argument("--output", "-o", help="Directory to save extracted frames")
